                            ...
                            <div   class="sidebar-holder">
                                ...
                                <div class="single-sidebar-box mt-30 wow fadeInUp animated ">
                                    ...
                                    <div class="checkbox-item">
                                            ...
                                            <div  v-if='filterList'  v-for='category in filterList.categories' class="form-group"> <input v-model='categories' :value="category.id" type="checkbox" :id="category.id"> <label
                                                    :for="category.id">{{category.title}}     {{categories}}</label> </div>
                                       
                                        
                                    </div>
                                </div>
                                <div class="single-sidebar-box mt-30 wow fadeInUp animated" v-if='filterList'>
                                    <h4>Color Option </h4>
                                    <ul class="color-option">
                                        <li v-for='color in filterList.colors' @click="addColor(color.id)" > <a href="#0" class="color-option-single" :style="{ background: color.color}"> <span>{{color.title}}</span> </a> </li>
                                ...
                                <div class="single-sidebar-box mt-30 wow fadeInUp animated pb-0 border-bottom-0 " v-if='filterList'>
                                    <h4>Tags </h4>
                                    <ul class="popular-tag">
                                        <li v-for='tag in filterList.tags' @click="addTag(tag.id)"><a href="#0">{{tag.title}}</a></li>
                            ...
                            <div class="col-xl-12">
                                <div
                                    ...
                                    <div class="left-box wow fadeInUp animated">
                                        <p>Showing 1–12 of 50 Results  dd  {{sort}}</p>
                                    </div>
                                    <div
                                            ...
                                            <div v-for='product in products' class="col-xl-4 col-lg-6 col-6 ">
                                                <div class="products-three-single w-100  mt-30">
                                                    <div class="products-three-single-img"> <router-link
                                                        ...
                                                        </div> <a @click="addToCart(product.id, true)"  class="addcart btn--primary style2">
                                                            Add To Cart </a>
                                                    ...
                                                    <div :id="`popup${product.id}`"  class="product-gird__quick-view-popup mfp-hide">
                                                        <div v-if="popupProduct" class="container">
                                                            <div class="row justify-content-between align-items-center">
                                                                <div class="col-lg-6">
                                                                    <div v-if="popupProduct.imagesUrl.length>2" class="quick-view__left-content">
                                                                        <div class="tabs">
                                                                            <div class="popup-product-thumb-box">
                                                                                <ul>
                                                                                    <li v-for="image in popupProduct.imagesUrl"
                                                                            ...
                                                                            <div class="popup-product-main-image-box">
                                                                                <div  v-for="image in popupProduct.imagesUrl" :id="`tabb${image.id}`"
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="popup-right-content">
                                                                        ...
                                                                        <div class="color-varient"> 
                                                                            <template v-for='groupProduct in popupProduct.group_id'>
                                                                            <a @click.prevent="getProduct(groupProduct.id)" v-for='color in groupProduct.colors' :href="`#${color.id}`"
                                                                            class="color-name"  v-bind:style="{ background: color.color}">{{groupProduct.id}}
                                                                        ...
                                                                        <div class="add-product">
                                                                            ...
                                                                            <div class="button-group">
                                                                                ...
                                                                                <button class="btn--primary " @click='addToCart(popupProduct.id,false)'> Add to
                                                                                    Cart </button>
                                                                            </div>
                                                                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 d-flex justify-content-center wow fadeInUp animated">
                                <ul class="pagination text-center">
                                    <li @click='getProducts(pagination.current_page -1)' v-if="pagination.current_page !==1" class="next"><a href="#0"><i class="flaticon-left-arrows"
                                    ...
                                    <template v-if="Number(link.label) && 
                                     (pagination.current_page - link.label === -2)&&
                                     pagination.current_page+2!==pagination.last_page||
                                     (pagination.current_page - link.label === 2) &&
                                    ...
                                    <a  @click='getProducts(pagination.current_page +1)' href="#0"><i class="flaticon-next-1"
                                                aria-hidden="true"></i> </a></li>
                                </ul>
                            </div>
                        </div>
...
export default{
    ...
    mounted(){
     ...
     //Nas rano
     let sortHtml = document.getElementsByClassName('nice-select')[2].children[1].children
     ...
     console.log(document.getElementsByClassName('nice-select')[2].children[1].children)
     //Nas rano
